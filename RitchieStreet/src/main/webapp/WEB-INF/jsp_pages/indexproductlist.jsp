                      ...
                      <c:forEach begin="0" end="7" var="microcontrollerList" items="${microcontrollerList}">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="addtocart?username=${User}&productId=${microcontrollerList.productId}&quantity=1&action=addtocart"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
